...
class RAGOrchestrator:
    ...
    def _detect_intent(self, query: str) -> StudentNeed:
        ...
        inst_kw = [
            ...
            "оплата", "договор", "пропуск", "карта", "кампус", "впи", "волжский политехнический институт"
    ...
    def _looks_like_institute_query(self, query: str) -> bool:
        ...
        inst_patterns = (
            ...
            "адрес", "контакты", "телефон", "почта",
            "как поступить", "поступление", "приемная комиссия", "приёмная комиссия", "ВПИ", "Волжский политехнический институт",
